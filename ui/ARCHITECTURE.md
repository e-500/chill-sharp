...
- [`chill-sharp-ui-core`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core): shared Angular library source
- npm package name: `@chill-sharp/ui-core`
- [`chill-sharp-ui-template`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template): Angular client shell template that depends on `@chill-sharp/ui-core`
...
### `ui/chill-sharp-ui-core`

[`chill-sharp-ui-core`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core) is the shared Angular library source.
...
- [`package.json`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/package.json)
- [`src/public-api.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/public-api.ts)

### `ui/chill-sharp-ui-template`

[`chill-sharp-ui-template`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template) is the starter Angular app shell for client repositories.
...
- [`auth-shell.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/layouts/auth-shell.component.ts)
- [`workspace-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/layouts/workspace-page.component.ts)
...
- auth pages:
  - [`login-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/login-page.component.ts)
  - [`register-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/register-page.component.ts)
  - [`reset-password-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/reset-password-page.component.ts)
  - [`confirm-reset-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/confirm-reset-page.component.ts)
- CRUD page:
  - [`crud-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/crud/crud-page.component.ts)
- permissions pages:
  - [`permissions-page.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/permissions/permissions-page.component.ts)
  - [`role-permission.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/permissions/role-permission.component.ts)
  - [`user-permission.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/permissions/user-permission.component.ts)
  - related dialogs/editors in the same folder
- Atlas event viewer:
  - [`event-viewer.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/pages/atlas/event-viewer/event-viewer.component.ts)
...
- [`crud-task.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/tasks/crud-task/crud-task.component.ts)
...
- [`chill.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/chill.service.ts)
- [`workspace.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/workspace.service.ts)
- [`workspace-task-registry.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/workspace-task-registry.service.ts)
- [`workspace-dialog.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/workspace-dialog.service.ts)
- [`workspace-layout.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/workspace-layout.service.ts)
- [`workspace-toolbar.service.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/services/workspace-toolbar.service.ts)
...
- [`chill-form.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/lib/chill-form.component.ts)
- [`chill-table.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/lib/chill-table.component.ts)
- [`chill-polymorphic-input.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/lib/chill-polymorphic-input.component.ts)
- [`chill-polymorphic-output.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/lib/chill-polymorphic-output.component.ts)
...
- [`src/styles/core-theme.scss`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/styles/core-theme.scss)
...
- [`provideChillSharpUiCore()`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/provide-chill-sharp-ui-core.ts)
- [`CHILL_SHARP_UI_ROUTES`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/chill-sharp-ui.routes.ts)
- [`ChillSharpUiRootComponent`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/chill-sharp-ui-root.component.ts)
...
- [`storage-keys.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-core/src/lib/storage-keys.ts)
...
- [`src/main.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/main.ts)

and configures the app in:

- [`src/app/app.config.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/app.config.ts)
...
- [`src/app/app.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/app.component.ts)
...
- [`src/app/app.routes.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/app.routes.ts)
...
- [`src/app/core/plugins/register-client-plugins.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/core/plugins/register-client-plugins.ts)
...
- [`src/app/core/overrides/register-client-overrides.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/core/overrides/register-client-overrides.ts)
...
- [`src/app/pages/client-home/client-home.component.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/app/pages/client-home/client-home.component.ts)
...
- [`src/config/app-config.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/config/app-config.ts)
- [`src/config/runtime-config.ts`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/config/runtime-config.ts)
- [`public/env.js`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/public/env.js)
- [`public/runtime-config.js`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/public/runtime-config.js)
...
- [`src/styles.scss`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/src/styles.scss)
...
- [`ci.yml`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/.github/workflows/ci.yml)
- [`deploy.yml`](/c:/source/personal/chill-sharp/chill-sharp/ui/chill-sharp-ui-template/.github/workflows/deploy.yml)
...
- built-in workspace tasks such as CRUD, permissions, and event viewer
...
```bash
npm install @chill-sharp/ui-core@0.1.0
```
...
chill-sharp-ui-core
  ...
  published as @chill-sharp/ui-core
  contains auth, workspace, CRUD, permissions, event viewer,
