...
namespace ChillSharp.Tests.EF.Model
{
    [ChillEntity(
        ...
        EnableMCP = true,
        MCPDescription = "Blog resource exposed to MCP clients.")]
    public class Blog : ChillEntity
    {
        ...
        [ChillProperty(
            ...
            MCPDescription = "Blog title used to identify the resource.")]
        ...
        [ChillProperty(
            ...
            MCPDescription = "Canonical blog URL.")]
        ...
        [ChillProperty(
            ...
            MCPDescription = "Posts associated with the blog.")]
