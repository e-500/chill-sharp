...
```powershell
npm install @chill-sharp/ui-core@1.0.122
```
...
```text
chill-sharp-ui-core-1.0.122.tgz
```
...
```text
C:\source\shared-npm-packages\chill-sharp-ui-core-1.0.122.tgz
```
...
```powershell
npm install C:\source\shared-npm-packages\chill-sharp-ui-core-1.0.122.tgz
```

If the package is on a network share:

```powershell
npm install \\my-server\shared-npm-packages\chill-sharp-ui-core-1.0.122.tgz
```
...
cd dist
npm pack
Copy-Item .\chill-sharp-ui-core-1.0.122.tgz C:\source\shared-npm-packages\
```
