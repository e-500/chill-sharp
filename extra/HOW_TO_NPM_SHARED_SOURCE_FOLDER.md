...
```text
chill-sharp-ui-core-1.0.120.tgz
```
...
```text
C:\source\shared-npm-packages\chill-sharp-ui-core-1.0.120.tgz
```
...
```powershell
npm install C:\source\shared-npm-packages\chill-sharp-ui-core-1.0.120.tgz
```

If the package is on a network share:

```powershell
npm install \\my-server\shared-npm-packages\chill-sharp-ui-core-1.0.120.tgz
```
...
cd dist
npm pack
Copy-Item .\chill-sharp-ui-core-1.0.120.tgz C:\source\shared-npm-packages\
```
