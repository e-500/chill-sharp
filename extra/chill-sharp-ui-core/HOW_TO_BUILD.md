...
From [`extra/chill-sharp-ui-core`](/c:/source/personal/chill-sharp/chill-sharp/extra/chill-sharp-ui-core):
...
4. bump the `version` in [`package.json`](/c:/source/personal/chill-sharp/chill-sharp/extra/chill-sharp-ui-core/package.json) when consumers need a new package revision
5. run `npm run build`
6. verify `dist/`
...
- The template application dependency is currently tracked in [`extra/chill-sharp-ui-template/package.json`](/c:/source/personal/chill-sharp/chill-sharp/extra/chill-sharp-ui-template/package.json).
