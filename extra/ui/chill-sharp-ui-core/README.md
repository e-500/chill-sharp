...
See [`HOW_TO_BUILD.md`](/c:/source/personal/chill-sharp/chill-sharp/extra/ui/chill-sharp-ui-core/HOW_TO_BUILD.md) for the workflow to rebuild, version, and publish the library after a change.
